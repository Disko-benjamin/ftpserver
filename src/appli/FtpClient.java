...
public class FtpClient {
    ...
    public static void openConnection() throws Exception {
        ...
        socket_client = new Socket(ip, (int) port);
            ...
            switch (cmd) {
                case "STOR":
                    ...
                    if (!file.exists()) {
                        writer.writeInt(-1);
                        writer.flush();
                        System.out.println("\nFile " + request.substring(request.lastIndexOf("/") + 1, request.length()) + " does not exist.\n");
                        break;
                    }
                    ...
                    writer.flush();
                    System.out.println("\nFile " + request.substring(request.lastIndexOf("/") + 1, request.length()) + " has been sent!\n");
                    break;
                ...
                case "RETR":
                    ...
                    String fileName = request.substring(request.lastIndexOf("/") + 1, request.length());
